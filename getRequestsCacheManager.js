...
let getRequestsCacheExpirationTime = serverVariables.get("main.getRequestscache.expirationTime");//set expirationTime
...
setInterval(GetRequestsCacheManager.flushExpired, getRequestsCacheExpirationTime * 1000);//strt time
